...
<div style="margin-top: 40px;">
	<div class="mdl-typography--display-1-color-contrast" style="font-weight: bold;margin-bottom: 30px;margin: auto;color: #602d08;">Contenido en el carrito</div>    <hr>
    <br>
    <p>Productos en el carrito</p>
    <br>
    <table class="mdl-data-table mdl-data-table--selectable mdl-shadow--2dp" style="width: 100%; margin-bottom: 10%;">
	  <thead>
	    <tr>
